                        ...
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                <div className='flex flex-col gap-1'>
                                    <h2 className='pb-2 font-semibold'>Deliver To : Raju bhan</h2>
                                    <p><span className='text-sm'>Kamla Nagar Agra Uttar Pradesh </span></p>
                                </div>
                                ...
                                <div className='mt-4 flex flex-col gap-4 bg-[#8288ed] rounded-md'>
                                    <div className='text-[#d0d2d6]'>
                                        <div className='flex gap-3 text-md'>
                                            <img className='w-[50px] h-[50px]' src="http://localhost:3000/images/category/2.jpg" alt="" />
                                            <div>
                                                <h2>Product Name here </h2>
                                                <p>
                                                    <span>Brand : </span>
                                ...
                                <div className='mt-4 flex flex-col gap-4 bg-[#8288ed] rounded-md'>
                                    <div className='text-[#d0d2d6]'>
                                        <div className='flex gap-3 text-md'>
                                            <img className='w-[50px] h-[50px]' src="http://localhost:3000/images/category/3.jpg" alt="" />
                                            <div>
                                                <h2>Product Name here </h2>
                                                <p>
                                                    <span>Brand : </span>
