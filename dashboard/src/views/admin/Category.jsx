...
const Category = () => {
    ...
    // For add category image handling
    const imageHandle = (e) => {
                                ...
                                <tbody>
                                    {
                                        ...
                                        <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'> <img className='w-[45px] h-[45px]' src={`http://localhost:3000/images/category/${d}.jpg`} alt="" /> </td>
